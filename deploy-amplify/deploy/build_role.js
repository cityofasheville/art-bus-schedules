...
import { role_settings, vpc_role_settings, secrets_manager_role_settings, invoke_lambda_role_settings, s3_role_settings, ses_role_settings, amplify_role_settings } from './settings/role_settings.js';
...
async function build_role(config) {
  ...
  if(config.lambda_options.amplify === 'true') {
    roleresult = roleresult + amplify_role_settings(config);
  }
